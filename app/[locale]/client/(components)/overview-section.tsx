...
const OverviewSection = () => {
  ...
  const overviewData = [
    ...
    { label: t(OVERVIEW_KEYS.HOME_OVERVIEW_INVESTOR), value: t(OVERVIEW_KEYS.HOME_OVERVIEW_INVESTOR_VALUE) },
    { label: t(OVERVIEW_KEYS.HOME_OVERVIEW_DEVELOPER), value: t(OVERVIEW_KEYS.HOME_OVERVIEW_DEVELOPER_VALUE) },
    { label: t(OVERVIEW_KEYS.HOME_OVERVIEW_CONSTRUCTION_CONTRACTOR), value: t(OVERVIEW_KEYS.HOME_OVERVIEW_CONSTRUCTION_CONTRACTOR_VALUE) },
    { label: t(OVERVIEW_KEYS.HOME_OVERVIEW_SUPERVISION_CONSULTANT), value: t(OVERVIEW_KEYS.HOME_OVERVIEW_SUPERVISION_CONSULTANT_VALUE) },
      ...
      <div className={styles.infoStrip}>
        <div className={styles.contentBox}>
          ...
          <div className={styles.rightCol}>
            ...
            <h2 className={`${styles.titleOverview} global-title`}>
